    ...
    create  table
      "dilemme_prisonnier"."main"."mart_taux_cooperation__dbt_tmp"
  
    as (
      

WITH combined AS (
    SELECT Player_A AS personnalite, Choix_P_A AS choix FROM "dilemme_prisonnier"."main"."stg_parquets"
    UNION ALL
    SELECT Player_B AS personnalite, Choix_P_B AS choix FROM "dilemme_prisonnier"."main"."stg_parquets"
)
SELECT
    personnalite,
